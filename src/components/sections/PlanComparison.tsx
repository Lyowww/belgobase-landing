...
export function PlanComparison() {
  ...
  const features = [
    ...
    {
      name: t("comparison.location"),
      minimum: false,
      plus: false,
      pro: true,
    },
    {
      name: t("comparison.marketingExpenses"),
      minimum: false,
      plus: false,
      pro: true,
    },
    {
      name: t("comparison.payrollCosts"),
      minimum: false,
      plus: false,
      pro: true,
    },
    {
      name: t("comparison.industryCodes"),
      minimum: false,
      plus: false,
      pro: true,
    },
    {
      name: t("comparison.customFilterCombinations"),
      minimum: false,
      plus: false,
      pro: true,
    },
