...
export function Process() {
  return (
    <section id="process" className="section-alt noise-overlay relative py-24 md:py-32">
            ...
            {steps.map((step, i) => (
              <SectionReveal key={step.number} delay={i * 0.15}>
                ...
                >
                  ...
                  <div className="rounded-2xl border border-border/60 bg-white p-8 shadow-sm transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-primary/5">
